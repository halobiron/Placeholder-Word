...
Browser-based visual testing via `ak:chrome-devtools` skill. Screenshots, responsive checks, accessibility audits, form automation, console error collection. Includes auth injection for protected routes.
...
6. For frontend: run UI tests via `ak:chrome-devtools` skill
...
- **Browser**: `ak:chrome-devtools` skill for UI testing (screenshots, ARIA, console, network)
