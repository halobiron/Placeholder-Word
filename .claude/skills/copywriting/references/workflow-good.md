...
1. **Screenshots provided** → Use `ak:ai-multimodal` skill for detailed context analysis
2. **Videos provided** → Use `ak:ai-multimodal` video-analysis for comprehensive context
