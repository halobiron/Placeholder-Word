...
- `/ak:kanban` - View dashboard for ./plans directory
- `/ak:kanban <dir>` - View dashboard for specific directory
- `/ak:kanban --stop` - Stop running server
...
The `/ak:kanban` command will evolve into **VibeKanban-inspired** AI agent orchestration:
...
Track progress: https://github.com/agentkit/agentkit-engineer/issues/189
