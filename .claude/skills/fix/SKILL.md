...
**Always activate:** `ak:debug` (all workflows)
**Conditional:** `ak:problem-solving`, `ak:sequential-thinking`, `ak:brainstorm`, `ak:context-engineering`
