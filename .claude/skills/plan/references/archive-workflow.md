...
### Step 2: Summarize the plans and document them with `/ak:journal` slash command
...
- Stage and commit the changes (Use `/ak:git cm` slash command)
- Commit and push the changes (Use `/ak:git cp` slash command)
