...
- Leverage `ak:ai-multimodal` skill to analyze visual materials and mockups
...
8. **Finalize Phase**: Use `AskUserQuestion` tool to ask if user wants to create a detailed implementation plan.
   - If `Yes`: Run `/ak:plan` command with the brainstorm summary context as the argument to ensure plan continuity.
