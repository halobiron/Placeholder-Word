#!/usr/bin/env python3
"""Integration tests for canonical ak-help query routing."""
...
def marker(output: str) -> str:
    for line in output.splitlines():
        if line.startswith("@AK_OUTPUT_TYPE:"):
            return line.replace("@AK_OUTPUT_TYPE:", "", 1).strip()
    return ""
...
def main() -> int:
    ...
    print("=" * 60)
    print("ak-help integration tests")
    print("=" * 60)
