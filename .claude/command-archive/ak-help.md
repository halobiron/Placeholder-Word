---
description: AgentKit usage guide - just type naturally
...
```bash
python .claude/scripts/ak-help.py "$ARGUMENTS"
```
...
- Use global (~/.claude/.ak.json) for personal preferences like language, issue prefix style
- Use local (./.claude/.ak.json) for project-specific paths, naming conventions
