...
### Architecture Conformance (BMAD)
**Before reviewing code, read `plans/artifacts/architecture.md` (if exists).** Verify that:
- Implementation follows documented architecture patterns
- API contracts match architecture specifications
- Data models align with architecture design
- No undocumented architectural decisions introduced

Flag any deviations and request changes or an ADR (Architecture Decision Record).
