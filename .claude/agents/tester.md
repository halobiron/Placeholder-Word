...
**IMPORTANT**: Before running tests, check if a test plan exists at `tests/plans/story-{slug}-test-plan.md` and use it to guide test execution. Read the corresponding story file from `plans/stories/` for acceptance criteria context.
