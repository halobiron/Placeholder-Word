...
This project is indexed by GitNexus as **placeholder** (11614 symbols, 22457 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/placeholder/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/placeholder/context` | Codebase overview, check index freshness |
| `gitnexus://repo/placeholder/clusters` | All functional areas |
| `gitnexus://repo/placeholder/processes` | All execution flows |
| `gitnexus://repo/placeholder/process/{name}` | Step-by-step execution trace |
